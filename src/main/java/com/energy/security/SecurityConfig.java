...
import com.energy.security.jwt.JwtAuthProvider;
import com.energy.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://127.0.0.1:8080/api");
        config.addAllowedOrigin("https://127.0.0.1:8080/api");
        config.addAllowedOrigin("ws://localhost:3000");
